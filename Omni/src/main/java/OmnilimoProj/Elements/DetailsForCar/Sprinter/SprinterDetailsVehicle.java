...
public class SprinterDetailsVehicle extends Boss{
...
//	}
	...
	public static void checkTypeOfVehicleSprinter() {
	...
	public static void checkTypeOfVehicleExecutiveMiniBus() {
	...
	public static void checkTypeOfVehicleBMW5Series() {
	...
	public void checkBaseCharges() {
		...
		assertEquals(CommonFunction.getLocator("$97.00").getText(), AdditionalFees.BaseChargesSprinter.getPrice());
		log.info("baseCharges checked");
	}

	public void checkFuelSurcharge() {
		Assert.assertEquals(fuelSurcharge.getText(), "Fuel Surcharge");
		assertEquals(CommonFunction.getLocator("$9.00").getText(), AdditionalFees.FuelSurchargeSprinter.getPrice());
	...
	public void checkSanitizationFee() {
		...
		assertEquals(CommonFunction.getLocator("$7.00").getText(), AdditionalFees.SanitizationFeeSprinter.getPrice());
	...
	public void checkGratuity() {
		...
		assertEquals(CommonFunction.getLocator("$19.40").getText(), AdditionalFees.GratuitySprinter.getPrice());
		log.info("gratuity checked");
	}

	public void checkCreditCarFee() {
		assertEquals(creditCarFee.getText(), "Credit Card Fee");
		assertEquals(CommonFunction.getLocator("$3.97").getText(), AdditionalFees.CreditCardFeeSprinter.getPrice());
	...
	public void checkPassengerRecoveryTransportationCharge() {
		...
		assertEquals(CommonFunction.getLocator("$3.39").getText(), AdditionalFees.PassengerRecoveryTransportationChargeSprinter.getPrice());
		log.info("Passenger Recovery Transportation Charge checked");
	}

	public void checkTotal() {
		assertEquals(total.getText(), "Total:");
		assertEquals(CommonFunction.getLocator("$139.76").getText(), "$" + Cars.Sprinter.getPrice());
	}
