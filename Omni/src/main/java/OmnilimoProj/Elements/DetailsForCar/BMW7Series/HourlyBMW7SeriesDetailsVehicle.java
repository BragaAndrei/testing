...
public class HourlyBMW7SeriesDetailsVehicle extends Boss {
...
//	WebElement typeOfVehicleBMW7Series;
	...
	public HourlyBMW7SeriesDetailsVehicle() {
...
//	}
	...
	public void checkBaseCharges() {
		...
		assertEquals(CommonFunction.getLocator("$598.50").getText(), AdditionalFees.BaseChargesBMW7SeriesHourly.getPrice());
		log.info("baseCharges checked");
	}

	public void checkFuelSurcharge() {
		Assert.assertEquals(fuelSurcharge.getText(), "Fuel Surcharge");
		assertEquals(CommonFunction.getLocator("$76.00").getText(), AdditionalFees.FuelSurchargeBMW7SeriesHourly.getPrice());
	...
	public void checkSanitizationFee() {
		...
		assertEquals(CommonFunction.getLocator("$3.00").getText(), AdditionalFees.SanitizationFeeBMW7SeriesHourly.getPrice());
		log.info("Sanitization Fee checked");
	}

	public void checkAirportParking() {
		assertEquals(airportParking.getText(), "Airport Parking");
		assertEquals(CommonFunction.getLocator("$5.00").getText(), AdditionalFees.AirportParkingBMW7SeriesHourly.getPrice());
		log.info("Airport Parking checked");
	}

	public void checkGratuity() {
		assertEquals(gratuity.getText(), "Gratuity");
		assertEquals(CommonFunction.getLocator("$119.70").getText(), AdditionalFees.GratuityBMW7SeriesHourly.getPrice());
		log.info("gratuity checked");
	}

	public void checkCreditCarFee() {
		assertEquals(creditCarFee.getText(), "Credit Card Fee");
		assertEquals(CommonFunction.getLocator("$23.92").getText(), AdditionalFees.CreditCardFeeBMW7SeriesHourly.getPrice());
	...
	public void checkPassengerRecoveryTransportationCharge() {
		...
		assertEquals(CommonFunction.getLocator("$20.33").getText(), AdditionalFees.PassengerRecoveryTransportationChargeBMW7SeriesHourly.getPrice());
	...
	public void checkTotalDiffAddress() {
		...
		assertEquals(CommonFunction.getLocatorSpanTag("$841.45").getText(), AdditionalFees.TotalBMW7SeriesHourly.getPrice());
	}
	...
	public void checkTotal() {
		assertEquals(total.getText(), "Total:");
		assertEquals(CommonFunction.getLocator("$841.45").getText(), "$" + Cars.BMW7SeriesHourly.getPrice());
	}
