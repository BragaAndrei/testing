...
public class BMW5DetailsVehicle extends Boss{
...
//	}
	...
	public void checkBaseCharges() {
		...
		assertEquals(CommonFunction.getLocator("$55.00").getText(), AdditionalFees.BaseChargesBMW5Series.getPrice());
		log.info("baseCharges checked");
	}

	public void checkFuelSurcharge() {
		Assert.assertEquals(fuelSurcharge.getText(), "Fuel Surcharge");
		assertEquals(CommonFunction.getLocator("$8.00").getText(), AdditionalFees.FuelSurchargeBMW5Series.getPrice());
	...
	public void checkSanitizationFee() {
		...
		assertEquals(CommonFunction.getLocator("$3.00").getText(), AdditionalFees.SanitizationFeeBMW5Series.getPrice());
	...
	public void checkGratuity() {
		...
		assertEquals(CommonFunction.getLocator("$11.00").getText(), AdditionalFees.GratuityBMW5Series.getPrice());
		log.info("gratuity checked");
	}

	public void checkCreditCarFee() {
		assertEquals(creditCarFee.getText(), "Credit Card Fee");
		assertEquals(CommonFunction.getLocator("$2.31").getText(), AdditionalFees.CreditCardFeeBMW5Series.getPrice());
	...
	public void checkPassengerRecoveryTransportationCharge() {
		...
		assertEquals(CommonFunction.getLocator("$1.98").getText(), AdditionalFees.PassengerRecoveryTransportationChargeBMW5Series.getPrice());
		log.info("Passenger Recovery Transportation Charge checked");
	}

	public void checkTotal() {
		assertEquals(total.getText(), "Total:");
		assertEquals(CommonFunction.getLocator("$81.29").getText(), "$" + Cars.BMW5Series.getPrice());
	}
