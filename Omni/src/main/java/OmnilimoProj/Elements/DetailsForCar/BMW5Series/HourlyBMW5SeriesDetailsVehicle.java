package OmnilimoProj.Elements.DetailsForCar.BMW5Series;
...
public class HourlyBMW5SeriesDetailsVehicle extends Boss {
...
//	WebElement typeOfVehicleBMW7Series;
	...
	public HourlyBMW5SeriesDetailsVehicle() {
...
//	}
	...
	public void checkBaseCharges() {
		...
		assertEquals(CommonFunction.getLocator("$330.00").getText(), AdditionalFees.BaseChargesBMW5SeriesHourly.getPrice());
		log.info("baseCharges checked");
	}

	public void checkFuelSurcharge() {
		Assert.assertEquals(fuelSurcharge.getText(), "Fuel Surcharge");
		assertEquals(CommonFunction.getLocator("$48.00").getText(), AdditionalFees.FuelSurchargeBMW5SeriesHourly.getPrice());
	...
	public void checkSanitizationFee() {
		...
		assertEquals(CommonFunction.getLocator("$3.00").getText(), AdditionalFees.SanitizationFeeBMW5SeriesHourly.getPrice());
		log.info("Sanitization Fee checked");
	}

	public void checkAirportParking() {
		assertEquals(airportParking.getText(), "Airport Parking");
		assertEquals(CommonFunction.getLocator("$5.00").getText(), AdditionalFees.AirportParkingBMW5SeriesHourly.getPrice());
		log.info("Airport Parking checked");
	}

	public void checkGratuity() {
		assertEquals(gratuity.getText(), "Gratuity");
		assertEquals(CommonFunction.getLocator("$66.00").getText(), AdditionalFees.GratuityBMW5SeriesHourly.getPrice());
		log.info("gratuity checked");
	}

	public void checkCreditCarFee() {
		assertEquals(creditCarFee.getText(), "Credit Card Fee");
		assertEquals(CommonFunction.getLocator("$13.41").getText(), AdditionalFees.CreditCardFeeBMW5SeriesHourly.getPrice());
	...
	public void checkPassengerRecoveryTransportationCharge() {
		...
		assertEquals(CommonFunction.getLocator("$11.43").getText(), AdditionalFees.PassengerRecoveryTransportationChargeBMW5SeriesHourly.getPrice());
	...
	public void checkTotalDiffAddress() {
		...
		assertEquals(CommonFunction.getLocatorSpanTag("$471.84").getText(), AdditionalFees.TotalBMW5SeriesHourly.getPrice());
	}
	...
	public void checkTotal() {
		assertEquals(total.getText(), "Total:");
		assertEquals(CommonFunction.getLocator("$471.84").getText(), "$" + Cars.BMW5SeriesHourly.getPrice());
	}
	...
	public void checkPriceDetailsDiffAddress() throws InterruptedException {
		this.checkTypeOfVehicleBMW5Series();
