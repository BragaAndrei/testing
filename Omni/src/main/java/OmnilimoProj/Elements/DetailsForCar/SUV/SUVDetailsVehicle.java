...
public class SUVDetailsVehicle extends  Boss{
...
//	}
	...
	public void checkBaseCharges() {
		...
		assertEquals(CommonFunction.getLocator("$85.00").getText(), AdditionalFees.BaseChargesSUV.getPrice());
		log.info("baseCharges checked");
	}

	public void checkFuelSurcharge() {
		Assert.assertEquals(fuelSurcharge.getText(), "Fuel Surcharge");
		assertEquals(CommonFunction.getLocator("$8.00").getText(), AdditionalFees.FuelSurchargeSUV.getPrice());
	...
	public void checkSanitizationFee() {
		...
		assertEquals(CommonFunction.getLocator("$3.00").getText(), AdditionalFees.SanitizationFeeSUV.getPrice());
	...
	public void checkGratuity() {
		...
		assertEquals(CommonFunction.getLocator("$17.00").getText(), AdditionalFees.GratuitySUV.getPrice());
		log.info("gratuity checked");
	}

	public void checkCreditCarFee() {
		assertEquals(creditCarFee.getText(), "Credit Card Fee");
		assertEquals(CommonFunction.getLocator("$3.39").getText(), AdditionalFees.CreditCardFeeSUV.getPrice());
	...
	public void checkPassengerRecoveryTransportationCharge() {
		...
		assertEquals(CommonFunction.getLocator("$2.88").getText(), AdditionalFees.PassengerRecoveryTransportationChargeSUV.getPrice());
	...
	public void checkTotalDiffAddress() {
		...
		assertEquals(CommonFunction.getLocatorSpanTag("$119.27").getText(), AdditionalFees.TotalSUV.getPrice());
	}
...
//	public void checkPriceDetailsSameAddress() throws InterruptedException {
//		this.checkTypeOfVehicleSUV();
//		this.checkAllPricesIncludeTaxesFeesTips();
//		this.clickDetailsButton();
//		this.checkBaseCharges();
