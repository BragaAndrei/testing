...
import OmnilimoProj.CommonValues.Constants;

public class VehiclePageElem extends Boss {
...
//	}
	...
	public void checkPassengerRecoveryTransportationCharge() {
		...
		assertEquals(pricePassengerRecoveryTransportationCharge.getText(), "$3.03");
		log.info("Passenger Recovery Transportation Charge checked");
	}

	public void checkTotal() {
		assertEquals(total.getText(), "Total:");
		assertEquals(price.getText(), "$" + Cars.SUV.getPrice());
	}
