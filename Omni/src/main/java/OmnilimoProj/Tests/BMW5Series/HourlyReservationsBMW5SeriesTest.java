...
import OmnilimoProj.Elements.DetailsForCar.BMW5Series.HourlyBMW5SeriesDetailsVehicle;
...
public class HourlyReservationsBMW5SeriesTest extends Boss{

	LogInElements logInElements;
	MainPage mainPage;
	HourlyBMW5SeriesDetailsVehicle hourlyBMW5SeriesDetailsVehicle;
	...
	public void stepsToRepBookHourly() throws InterruptedException {
		...
		hourlyBMW5SeriesDetailsVehicle = new HourlyBMW5SeriesDetailsVehicle();
		hourlyBMW5SeriesDetailsVehicle.clickNextButton();
		hourlyBMW5SeriesDetailsVehicle.clickNextButton();
		hourlyBMW5SeriesDetailsVehicle.clickNextButton();
		hourlyBMW5SeriesDetailsVehicle.clickNextButton();
		hourlyBMW5SeriesDetailsVehicle.checkPriceDetailsDiffAddress();
		...
		hourlyBMW5SeriesDetailsVehicle.checkDetailsOnConfirmationPageDiffAddress();
