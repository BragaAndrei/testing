...
public class HourlyReservationsBMW7SeriesTest extends Boss {

	LogInElements logInElements;
	MainPage mainPage;
	HourlyBMW7SeriesDetailsVehicle hourlyBMW7SeriesDetailsVehicle;
	...
	public void stepsToRepBookHourly() throws InterruptedException {
		...
		mainPage.actionHourly("LAS Concourse D", "9.5", "10:50 AM");

		hourlyBMW7SeriesDetailsVehicle = new HourlyBMW7SeriesDetailsVehicle();
		hourlyBMW7SeriesDetailsVehicle.clickNextButton();
		hourlyBMW7SeriesDetailsVehicle.checkPriceDetailsDiffAddress();
		...
		hourlyBMW7SeriesDetailsVehicle.checkDetailsOnConfirmationPageDiffAddress();
